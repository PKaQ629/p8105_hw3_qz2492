...
We can tell from the picture that the average max temperature in July is significantly higher than it in January. Besides, the average max temperature in every station of NYC seemed to have the same tendency of temperature changes, and this had nothing to do with month. The lines in this picture are approximately parallel. But there are still some outliers like the point in January, 1982 and the point in July, 1988, which are extremly lower than the average.
